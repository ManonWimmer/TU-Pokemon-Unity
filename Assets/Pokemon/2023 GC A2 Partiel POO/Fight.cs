...
namespace _2023_GC_A2_Partiel_POO.Level_2
{
    public class Fight
    {
        public Fight(Character character1, Character character2)
        {
            ...
            {
                throw new ArgumentNullException("au moins 1 character du fight est null");
            }
        ...
        public void ExecuteTurnWithFactorType(Skill skillFromCharacter1, Skill skillFromCharacter2)
        {
            if (Character1.Speed > Character2.Speed)
            {
                Character2.ReceiveAttackWithFactorType(skillFromCharacter1);
                if (Character2.IsAlive)
                {
                    Character1.ReceiveAttackWithFactorType(skillFromCharacter2);
                }
            }
            else
            {
